...
AMenuSystemCharacter::AMenuSystemCharacter() :
	CreateSessionCompleteDelegade(FOnCreateSessionCompleteDelegate::CreateUObject(this, &ThisClass::OnCreateSessionComplete)),
	FindSessionsCompleteDelegade(FOnFindSessionsCompleteDelegate::CreateUObject(this, &ThisClass::OnFindSessionsComplete)),
...
void AMenuSystemCharacter::CreateGameSession()
{
	...
	OnlineSessionInterface->AddOnCreateSessionCompleteDelegate_Handle(CreateSessionCompleteDelegade);
...
void AMenuSystemCharacter::JoinGameSession()
{
	if (GEngine)
	{
		GEngine->AddOnScreenDebugMessage(
			...
			15.f,
			FColor::Blue,
			FString::Printf(TEXT("Begin session search"))
		);
	}
	if (!OnlineSessionInterface.IsValid())
	{
	...
	OnlineSessionInterface->AddOnFindSessionsCompleteDelegate_Handle(FindSessionsCompleteDelegade);
...
void AMenuSystemCharacter::OnFindSessionsComplete(bool bWasSuccessful)
{
	if (GEngine)
	{
		GEngine->AddOnScreenDebugMessage(
			...
			15.f,
			FColor::Blue,
			FString::Printf(TEXT("Completed session search"))
		);
	}
	if (!OnlineSessionInterface.IsValid())
	{
